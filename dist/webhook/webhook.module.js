...
exports.WebhookModule = WebhookModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [webhook_processor_service_1.WebhookProcessorService, medicine_resolver_service_1.MedicineResolverService],
        exports: [medicine_resolver_service_1.MedicineResolverService],
    })
], WebhookModule);
